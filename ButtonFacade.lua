		...
		elements = {
			...
			args = {
				...
				__bf_gloss = {
					...
					name = L["Gloss"],
					tristate = true,
					get = function() return global_gloss end,
					set = function(info,c) bf:SkinGloss(c) global_gloss = c and true or false end,
					order = 3,
					width = "half",
				},
				__bf_backdrop = {
				...
				elements_args[v] = {
					...
					args = {
						...
						__bf_gloss = {
							type = 'toggle',
							name = L["Gloss"],
							get = function() return g.Gloss end,
							set = function(info,c) g:Skin(g.SkinID,c,g.Backdrop) global_gloss = nil end,
							order = 3,
							width = "half",
						},
						__bf_backdrop = {
