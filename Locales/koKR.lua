...
L["This section will allow you to skin the buttons of the add-ons and add-on groups registered with Masque."] = "여기서는 Masque에 등록된 애드온 및 애드온 그룹의 버튼에 스킨을 씌울 수 있습니다."
