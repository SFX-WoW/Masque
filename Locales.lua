...
do
	local LOC = GetLocale()
	if LOC == "deDE" then
--@localization(locale="deDE", format="lua_additive_table", table-name="ns.L", handle-unlocalized="ignore")@
	elseif LOC == "esES" then
--@localization(locale="esES", format="lua_additive_table", table-name="ns.L", handle-unlocalized="ignore")@
	elseif LOC == "esMX" then
--@localization(locale="esMX", format="lua_additive_table", table-name="ns.L", handle-unlocalized="ignore")@
	elseif LOC == "frFR" then
--@localization(locale="frFR", format="lua_additive_table", table-name="ns.L", handle-unlocalized="ignore")@
	elseif LOC == "koKR" then
--@localization(locale="koKR", format="lua_additive_table", table-name="ns.L", handle-unlocalized="ignore")@
	elseif LOC == "ruRU" then
--@localization(locale="ruRU", format="lua_additive_table", table-name="ns.L", handle-unlocalized="ignore")@
	elseif LOC == "zhCN" then
--@localization(locale="zhCN", format="lua_additive_table", table-name="ns.L", handle-unlocalized="ignore")@
	elseif LOC == "zhTW" then
--@localization(locale="zhTW", format="lua_additive_table", table-name="ns.L", handle-unlocalized="ignore")@
	end
end
